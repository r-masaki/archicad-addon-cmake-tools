...
function (GenerateAddOnProject target acVersion devKitDir addOnSourcesFolder addOnResourcesFolder addOnLanguage additionalIncludeDirs)
    ...
    if (WIN32)
        add_custom_command (
            ...
            COMMAND ${Python3_EXECUTABLE} "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/MakeACLib.py" "${addOnLanguage}"
